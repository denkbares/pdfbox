 ...
 */
package org.apache.lapfdtextpdfbox.pdmodel.graphics.xobject;
...
import org.apache.lapfdtextpdfbox.filter.FlateFilter;
import org.apache.lapfdtextpdfbox.pdmodel.PDDocument;
import org.apache.lapfdtextpdfbox.pdmodel.common.PDStream;
import org.apache.lapfdtextpdfbox.pdmodel.common.function.PDFunction;
...
public class PDPixelMap extends PDXObjectImage
{
     ...
     *
	 * @deprecated Use {@link PDStream#getDecodeParms() } instead
	 */
     ...
     *
	 * @deprecated see {@link FlateFilter}
	 *
     */
