 ...
 */
package org.apache.lapfdtextpdfbox.pdmodel.interactive.digitalsignature.visible;
...
public interface PDFTemplateBuilder {
     ...
     * @param procSet
     */
	void injectProcSetArray(PDXObjectForm innerForm, PDPage page, PDResources innerFormResources,
     ...
     * @throws IOException
     */
	void injectAppearanceStreams(PDStream holderFormStream, PDStream innterFormStream, PDStream imageFormStream,
